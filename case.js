...
reply(`Bot Mode successfully 💠 changed to Private`)
}
break;
//━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━//
        case 'autotyping':
...
case 'uptime':
case 'runtime': {
    m.reply(`⏱️ Yo! I’ve been grinding for *${runtime(process.uptime())}* dude 🗿`)
}
break;
 //━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━//       
 case 'autobio':
...
if (!m.isGroup) return reply(mess.group);
    ...
    await supreme.sendMessage(m.chat, { text: message, mentions: activeUsers.map(u => u.jid) }, { quoted: m });
}
break;
  //━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━//   
   case 'setprefix':
...
const path = require("path");
  ...
  try {
    ...
    m.reply("I hit a snag dude! All APIs might be down or unable to process the request.");
  } catch (error) {
    m.reply("Download failed\n" + error.message);
  }
}

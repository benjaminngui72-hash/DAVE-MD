    ...
    try {
        ...
        try {
            ...
            if (!downloadData || !downloadData.data || downloadData.data.length === 0) {
                ...
                if (apiResponse.data?.status === 200 && apiResponse.data.tiktok) {
            ...
            if (!downloadData || !downloadData.data || downloadData.data.length === 0) {
                return await sock.sendMessage(chatId, { text: "No media found at the provided link. Please try again with a different link." });
            }
